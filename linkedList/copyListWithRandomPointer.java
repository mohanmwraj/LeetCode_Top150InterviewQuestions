...
public class copyListWithRandomPointer {
    ...
    /*
        ...
        * We then make two recursive calls, one using the random pointer and the other using next pointer.
    ...
    public Node copyRandomList_1(Node head) {
        ...
        node.next = this.copyRandomList_1(head.next);
        node.random = this.copyRandomList_1(head.random);
